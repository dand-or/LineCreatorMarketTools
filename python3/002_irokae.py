...
img_crop = img.point(lambda x: x * 1.1).save("./i_01.png", quality=95)
img = Image.open("./i_02.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_02.png", quality=95)
img = Image.open("./i_29.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_29.png", quality=95)
img = Image.open("./i_30.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_30.png", quality=95)
img = Image.open("./i_03.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_03.png", quality=95)
img = Image.open("./i_04.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_04.png", quality=95)
img = Image.open("./i_05.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_05.png", quality=95)
img = Image.open("./i_06.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_06.png", quality=95)
img = Image.open("./i_07.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_07.png", quality=95)
img = Image.open("./i_08.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_08.png", quality=95)
img = Image.open("./i_25.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_25.png", quality=95)
img = Image.open("./i_26.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_26.png", quality=95)
img = Image.open("./i_09.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_09.png", quality=95)
img = Image.open("./i_10.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_10.png", quality=95)
img = Image.open("./i_27.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_27.png", quality=95)
img = Image.open("./i_28.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_28.png", quality=95)
img = Image.open("./i_20.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_20.png", quality=95)
img = Image.open("./i_21.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_21.png", quality=95)
img = Image.open("./i_12.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_12.png", quality=95)
img = Image.open("./i_13.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_13.png", quality=95)
img = Image.open("./i_14.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_14.png", quality=95)
img = Image.open("./i_15.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_15.png", quality=95)
img = Image.open("./i_16.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_16.png", quality=95)
img = Image.open("./i_17.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_17.png", quality=95)
img = Image.open("./i_18.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_18.png", quality=95)
img = Image.open("./i_19.png")
img_crop = img.point(lambda x: x * 1.1).save("./i_19.png", quality=95)
img = Image.open("./a_20.png")
img_crop = img.point(lambda x: x * 1.1).save("./a_20.png", quality=95)
img = Image.open("./a_21.png")
img_crop = img.point(lambda x: x * 1.1).save("./a_21.png", quality=95)
